...
With Event sourcing, model your domain as commands, events, aggregates and _materialised/projected_ views.

Taking the simple CQRS example above:
![aws-event-sourcing-msk-cqrs.png](/uploads/aws/summit-2020/aws-event-sourcing-msk-cqrs.png)